...
.font50[**Nota**: C++ **não** é uma linguagem de programação de paradigma funcional. C++ é uma linguagem orientada à objeto - OO. Porém, a frase de seu criador se encaixa como filosofia para uso de funcionais. 
]]
